  ...
  return <div className="auth-main">
    <Container className="auth-container">
      <Box className='left-block'>
        ...
        <Box className='auth-block'>
          ...
          <div className="sign-block">
            <Typography variant="h2"  color='grey' style={{cursor: 'pointer', fontFamily: 'Mulish', fontWeight: '700', fontSize: '50px'}}>Sign in</Typography>
      ...
      <Box className='right-block'>
        <img src="https://i.ibb.co/QC5Qfvn/3d-business-young-man-got-an-idea.png" alt="error" width='400px'/>
      </Box>
    </Container>
  </div>;
};
